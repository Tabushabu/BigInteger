...
jsarmend
pa4
This contains the list headers for functions and routines to multiply extremly large integers
...
void setPower(BigInteger N, int base);
// Access functions -----------------------------------------------------------
// sign()
...
//Multiples the big integer by a constant c
